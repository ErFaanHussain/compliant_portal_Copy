...
<div class="container-fluid px-0">
  <div class="col-md-9"  style="float:left !important; margin-bottom: 60px;" id="MainDashboard1">
      ...
      ?>
        <div class="card card-outline-info" style="margin-top:10px;">
          ...
          <div class="card-block px-0 py-2">
                <div id="commentCont<?php echo $returned["topic_id"];?>" class="input-group col-md-9 px-0 pb-0">
                  ...
                  <span class="input-group-btn">
                    <button id="commentPost" class="btn btn-outline-info" onclick="postComment(<?php echo $returned['topic_id']; ?>);"><i class="fa fa-paper-plane" aria-hidden="true"></i>  Post</button>
                  </span>
                  </div>
									<?php
            ...
            <div class="collapse" id="<?php echo $returned['topic_id']; ?>">
              <div class="card card-block mx-0" style="max-height:300px; overflow-y: scroll;" id="commentCard<?php echo $returned['topic_id'];?>">
            <?php
  ...
  <div class="col-md-3" style="float:left !important; margin-bottom: 60px;">
        <!-- List-Group Panel -->
...
<div class="footer container-fluid px-0 text-center text-muted">
    <p class="my-0 text-white"><i class="fa fa-code" aria-hidden="true"></i> with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="facebook.com/erfaanhussain6">ErFaan</a> &amp; <a href="facebook.com/erfaanhussain6">Umar</a> </p>
    <small class="my-0 text-white">Copyright &copy; DOCS - IUST 2017 </small>
  </div>
</body>
</html>

	...
	<div class="header px-0 mr-0">
    	<div class="container-fluid px-0">
    		<div class="row px-0 mx-0">
    			<div class="col-md-2">
    				<a href="http://iustlive.com"><img src="images/logo.png" class="img-fluid" alt="IUST Logo"></a>
    			</div>
...
<div class="container-fluid px-0">		
	<nav class="navbar navbar-toggleable-md navbar-inverse bg-primary naVcustom">
...
<!-- Links -->
		<div class="collapse navbar-collapse" id="nav-content">   
			<ul class="nav1 navbar-nav" >
				...
				<li class="nav-item">
					<a class="nav-link" href="../admin_section/depttLogin.php">Admin Login</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="../admin_section/">Super Admin Login</a>
				</li>
			</ul>
		</div>
	</nav>

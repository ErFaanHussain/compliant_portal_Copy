    ...
    <script src="js/stProfileJS.js"></script>
...
<!-- Links -->
		<div class="collapse navbar-collapse" id="nav-content">
			<ul class="navbar-nav mr-auto" >
				...
				<li class="nav-item" id="postLink">
					<a class="nav-link"  href="postComplaint.php">Post Complaint</a>
				</li>
				<li class="nav-item">
...
<!-- Student Profile Update - Settings -->
<?php
  $sql7 = "SELECT `studentName`,`studentEmail`,`username`,`password` FROM `tbl_students` WHERE `studentID`=".$_SESSION["studentID"];
  $res7 = $con->query($sql7);
  if($res7->num_rows){
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="updateForm">
          <input type="hidden" name="aId" id="aId" value="<?php echo $_SESSION["studentID"];?>">
            <div class="form-group row">
            <label for="name" class="col-3 col-form-label">Name</label>
              <div class="col-9" id="nameCont">
                <input class="form-control" type="text" value="<?php echo $adDetails["studentName"];?>" id="name" disabled>
              </div>
            </div>
            <div class="form-group row">
            <label for="username" class="col-3 col-form-label">Email</label>
              <div class="col-9" id="emailCont">
                <input class="form-control" type="email" name="email1" value="<?php echo $adDetails["studentEmail"];?>" id="email" disabled>
              </div>
            </div>
            <div class="form-group row">

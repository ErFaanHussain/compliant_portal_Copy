...
<div class="container-fluid px-0">
	...
	<?php
	$search_query="SELECT `ComptID`,`comptRef`,`studentID`,`date`,`subject`,`compliant`,`reply`,`DeptID`,`replyDate`,`status` FROM `tbl_compliant` WHERE `publish_flag`='Y'";
									  ...
									  <div class="modal-dialog modal-lg" role="document">
									    <div class="modal-content">
									      <div class="modal-header">
									        <h6 class="modal-title" id="exampleModalLabel">Posted By: <?php echo $stdDetails["studentName"];?></h6><p><small>Reference: <?php echo $returned["comptRef"]?></small></p>

        ...
        <div class="card card-outline-info" style="margin-top:10px;">
          ...
          <div class="card-block px-0 py-2">
                <div id="commentCont<?php echo $returned["topic_id"];?>" class="input-group col-md-9 pl-0 pr-1 pb-0">
                  <textarea class="form-control ml-2" id="comment<?php echo $returned["topic_id"];?>" name="comment" placeholder="Write your comment..." maxlength="200" rows="1"></textarea>
                  <span class="input-group-btn">
					...
					<?php
						...
						if($res5->num_rows){
							...
							?>
								<span class="text-primary pb-1">0 Comments</span>
							<?php
						}
					 ?>

...
<div class="navbar-brand hidden-lg-up">Feedback Portal</div>
<!-- Links -->
<div class="collapse navbar-collapse" id="nav-content">
  <ul class="navbar-nav mr-auto" >
    ...
    <li class="nav-item" id="forumLink">
      <a class="nav-link"  href="aDiscussionForum.php">Forum</a>
    </li>
    <li class="nav-item" id="deptManager">
      <a class="nav-link"  href="dManagement.php">Management</a>
    </li>
    <li class="nav-item">
...
<?php
  $sql7 = "SELECT `name`,`UserName`,`email` FROM `tbl_superadmin` WHERE `ID`=".$_SESSION["adminID"];
  $res7 = $con->query($sql7);
  if($res7->num_rows){

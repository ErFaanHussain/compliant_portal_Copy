$(document).ready(function(){
    ...
    $( "#updateForm" ).validate( {
        ...
        messages: {
          name1: {
            ...
            rangelength: "Name must be 5-30 characters long",
  ...
  $("#saveBtn").click(function(){
    ...
    console.log("plag="+pFlag);
    // console.log(id+'\n'+username+'\n'+name+'\n'+password);
    if(!username == "" && !name == "" && !id == "" && !password == "" && !email == ""){
      console.log(id+'\n'+username+'\n'+name+'\n'+password+'\n'+email);
      jQuery.post("ajax/dAdminUpdateProfile.php",{ uName : username, Name : name, iD : id, Flag : pFlag, Password : password, Email: email },

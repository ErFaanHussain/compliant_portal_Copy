	...
	if($query_result->num_rows)
	{
      ...
      ?>
			<div class="card" id="card<?php echo $returned["ComptID"];?>" style="margin-top:10px;">
				<h6 class="card-header pb-0" style="background:#dbe3ea;">
				...
				<?php }
					...
					<div class="card-block py-1">
						...
						<h6 class="text-muted"> <label class="form-control-label"><strong>To:  </strong></label><?php echo " ".$deptDet["DeptName"]; ?> </h6>
					...
					<div class="card-footer text-muted py-0">
						<div style="margin-top:4px; margin-bottom:4px;">
							...
							<?php if($returned["status"] == 1 && $returned["resolvedFlag"] == 'N'){ ?>
			                    <button type="button" class="btn btn-outline-danger btn-sm" data-toggle="modal" data-target="#followUpModal" id="followUp<?php echo $returned["ComptID"];?>" onclick="followUp(<?php echo $returned['ComptID']; ?>);"><i class="fa fa-quote-left" aria-hidden="true"></i> Follow Up</button>
			                <?php }else{ ?>
			                    <button type="button" class="btn btn-outline-danger btn-sm" disabled data-toggle="modal" data-target="#followUpModal" id="followUp<?php echo $returned["ComptID"];?>" onclick="followUp(<?php echo $returned['ComptID']; ?>);"><i class="fa fa-quote-left" aria-hidden="true"></i> Follow Up</button>
			                  <?php }?>
	...
	<div class="modal fade" id="forwardModal" tabindex="-1" role="dialog" aria-labelledby="forwardModalLabel" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-primary" id="saveForward">Save</button>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="form-group" id="followUpCont">
                <textarea class="form-control" id="followUpText" rows="3" maxlength="300" placeholder="Write Follow Up here" value=""></textarea>
              <small id="resFollowUp"></small>
            </div>
            <strong><p id="mesFollowUp"></p></strong>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-outline-primary" id="saveFollowUp"><i class="fa fa-share" aria-hidden="true"></i> Post</button>
            <button type="button" class="btn btn-outline-danger" data-dismiss="modal"><i class="fa fa-times" aria-hidden="true"></i> Close</button>
          </div>
        </div>
      </div>
